...
welcome_page = st.Page("welcome.py", title="Welcome Page", icon=":material/quiz:", default=(role in ["ADMIN", "baseline", "static_exp", "static_with_dialogue", "dialogue_only"]))
...
done_post_treatment_page = st.Page(
    ...
    title="Thank You", icon=":material/quiz:",
    default = (role == "DONE" )
)
...
if not st.session_state.get("logged_in", False):
    # This wraps your login function as a standalone page
