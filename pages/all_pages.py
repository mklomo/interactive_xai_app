...
all_pages = {
    ...
    "pre_treatment_survey": st.Page("pages/pre_treatment_survey.py", title="Survey", icon=":material/quiz:"),
    "post_treatment_survey": st.Page("pages/post_treatment_survey.py", title="Survey", icon=":material/quiz:"),
    ...
    "stage_3_intro": st.Page("pages/stage_3_intro.py", title="Welcome to Stage 3", icon=":material/quiz:"),
